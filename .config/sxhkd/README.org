...
# Visit and copy bookmark
super + q; b; b
    ~/.local/bin/bookmark --select --brave --google --visit --copy --notify &
#+end_src
...
super + q; h; h
    ~/.local/bin/brohistory --bro="brave" --bro-limit=999999999 --dmenu --prompt="visit link in $BROWSER" --copy --visit --visit-in=brave &
#+end_src
...
# Type history link
super + q; h; t
    ~/.local/bin/brohistory --bro="brave" --bro-limit=999999999 --dmenu --prompt="select link" --copy --type &
#+end_src

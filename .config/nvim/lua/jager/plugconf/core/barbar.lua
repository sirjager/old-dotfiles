...
pkg.setup {
  ...
  clickable = true, -- left-click: go to buffer  middle-click: delete buffer
  focus_on_close = "left", -- A buffer to this direction will be focused (if it exists) when closing the current buffer. 'left' (default) or 'right'

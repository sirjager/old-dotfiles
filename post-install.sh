...
while true; do
  ...
  _clr yellow " 1.  Update system                       2.  Install yay       3. Install core pkgs"
  _clr yellow " 4.  Mount NTFS storage                  5.  Setup SDDM        6. Setup Firewall"
  _clr yellow " 7.  Setup Tmux                          8.  Setup Dotfiles    9. Install ZSH"
  _clr yellow " 10.  Install Hyprland                   11. Uninstall Hyprland "

  echo " "
  _clr yellow "0. Quit or Ctrl+C"
